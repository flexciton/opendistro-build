...
#
  ...
  do
    ...
    curl -H "Authorization: token ${SETUP_TOKEN}" --request POST "${GIT_URL_API}/${GIT_URL_REPO}/actions/runners/registration-token
    ...
    echo instancerunnertoken $instance_runner_token
